...
const Portfolio = () => {
    const projects = [
        ...
        { id: 4, image: "public/3.jpg", title: "Green Shadow Crop Management System", description: "Using React and Express.js and ORM prisma", link: "https://github.com/amashamaduwanthi/Green-Shadow-React.git", link:"https://github.com/amashamaduwanthi/Green-Shadow-Backend-Express.git" },
